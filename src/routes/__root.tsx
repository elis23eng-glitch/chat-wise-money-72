...
import { LimparCacheAntigo } from "@/components/LimparCacheAntigo";
import { AlertaVersaoApp } from "@/components/AlertaVersaoApp";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Essa página não existe ou foi movida. Sem problema, vamos voltar ao começo.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wise Money — assistente financeiro por conversa" },
      {
        name: "description",
        content:
          "Registre gastos conversando, acompanhe metas e entenda suas finanças com uma linguagem simples.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#B8E0D8" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "default" },
      { name: "apple-mobile-web-app-title", content: "Wise Money" },
    ],
    links: [
